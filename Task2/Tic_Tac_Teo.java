...
public class Tic_Tac_Teo extends JPanel implements ActionListener {
	...
	// COLORS
	Color turtle = new Color(0xc5afb5);
	Color orange = new Color(0x5E4B3B);
	...
	public void drawUI(Graphics page) {
		...
		// DRAW score X
		ImageIcon xIcon = new ImageIcon("C:\\Users\\Nishanthi\\eclipse-workspace\\LGM_Intern\\Resource\\Image\\orangex.png");
		...
		if (gameDone) {
			...
			if (playerX) {
				page.drawString("Player1 's Turn", 325, 180);
			} else {
				page.drawString("Player2 's Turn", 325, 180);
			}
		}
		// DRAW LOGO
		Image cookie = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Nishanthi\\eclipse-workspace\\LGM_Intern\\Resource\\Image\\cook.png");
	...
	public static void main(String[] args) {
		...
		Tic_Tac_Teo Tic_Tac_Teo = new Tic_Tac_Teo();
		frame.add(Tic_Tac_Teo);
		...
		frame.addWindowListener(new WindowAdapter() {
			public void windowOpened(WindowEvent e) {
				try {
					...
					Tic_Tac_Teo.setPlayerXWins(Integer.parseInt(sc.nextLine()));
					Tic_Tac_Teo.setPlayerOWins(Integer.parseInt(sc.nextLine()));
					sc.close();
			...
			public void windowClosing(WindowEvent e) {
				try {
					...
					pw.write("");
					pw.write(Tic_Tac_Teo.player1wins + "\n");
					pw.write(Tic_Tac_Teo.player2wins + "\n");
					pw.close();
